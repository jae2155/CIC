...
# 2000, 2004/2008, and 2012 presidential elections using Monte Carlo Simulation,
# assuming that each state is equally likely to vote Republican or Democrat.
#######################
...
def main():
    ...
    votes_2000 = [  
            9,  3,  8,  6, 54,  8,  8,  3,  3, 25, 13,  4,  4, 22, 12,  7,  6,
            8,  9,  4, 10, 12, 18, 10,  7, 11,  3,  5,  4,  4, 15,  5, 33, 14,
            3, 21,  8,  7, 23,  4,  8,  3, 11, 32,  5,  3, 13, 11,  5, 11,  3,
    ]
